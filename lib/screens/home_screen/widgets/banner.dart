...
class MainBanner extends StatelessWidget {
  MainBanner({super.key, required this.homeScreenController});
      ...
      child: RoundedRectangleBox(
        ...
        child: Column(
          ...
          children: [
            ...
            FutureWidget(homeScreenController.updateUserBalance(), Obx(() {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: _appTheme.textTheme.hero.copyWith(color: _appTheme.colorScheme.blue30),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: _appTheme.textTheme.hero.copyWith(color: _appTheme.colorScheme.yellow),
            ),
            const SizedBox(height: spacing4),
            Text(
              AppStrings.youHaveALotOfBonusesYouCanOrderSomethingForYourself
